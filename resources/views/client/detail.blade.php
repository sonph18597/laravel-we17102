                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                        ...
                        <img id="mat_truoc_preview"
                            ...
                            alt="your image" style="max-width: 300px; height:300px; margin-bottom: 10px;"
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                        <div class="prd_details">
                            ...
                            <div class="prt_01 mb-2"><span
                                    class="text-success bg-light-success rounded px-2 py-1">Women's Suit</span></div>
                            <div class="prt_02 mb-3">
                                ...
                                <div class="text-left">
                                    ...
                                    <div class="elis_rty"><span
                                            class="ft-bold theme-cl fs-lg">${{ $objItem->price }}</span></div>
                                </div>
                            </div>
                            ...
                            <div class="prt_04 mb-4">
                                <p class="d-flex align-items-center mb-1">Color:<strong
                                        class="fs-sm text-dark ft-medium ml-1">{{ $objItem->color }}</strong></p>
                            </div>

                            <div class="prt_04 mb-4">
                                <p class="d-flex align-items-center mb-1">Size:<strong
                                        class="fs-sm text-dark ft-medium ml-1">{{ $objItem->size }}</strong></p>
                            </div>
                            <div class="prt_04 mb-4">
                                <p class="d-flex align-items-center mb-1">Category:<a href=""
                                        class="fs-sm text-dark ft-medium ml-1"></a></p>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                            <div class="footer_widget">
                                <img src="{{ asset('client/img/logo-light.png') }}" class="img-footer small mb-2"
                                    alt="" />
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                            <div class="footer_widget">
                                ...
                                <div class="address mt-3">
                                    ...
                                    <div class="scr_payment"><img src="{{ asset('') }}client/img/card.png"
                            ...
                            <div class="quick_view_thmb">
                                <div class="quick_view_slide">
                                    <div class="single_view_slide"><img
                                            src="{{ asset('') }}client/img/product/1.jpg" class="img-fluid"
                                            alt="" /></div>
                                    <div class="single_view_slide"><img
                                            src="{{ asset('') }}client/img/product/2.jpg" class="img-fluid"
                                            alt="" /></div>
                                    <div class="single_view_slide"><img
                                            src="{{ asset('') }}client/img/product/3.jpg" class="img-fluid"
                                            alt="" /></div>
                                    <div class="single_view_slide"><img
                                            src="{{ asset('') }}client/img/product/4.jpg" class="img-fluid"
                                            alt="" /></div>
                                </div>
                            </div>
                                ...
                                <div class="sl_cat_01">
                                    <div
                                        ...
                                        <a href="javascript:void(0);" class="d-block"><img
                                                src="{{ asset('') }}client/img/tshirt.png" class="img-fluid"
                                                width="40" alt="" /></a>
                                    </div>
                                </div>
                                <div class="sl_cat_02">
                            ...
                            <div class="cats_side_wrap text-center">
                                <div class="sl_cat_01">
                                    <div
                                        class="d-inline-flex align-items-center justify-content-center p-3 circle mb-2 gray">
                                        <a href="javascript:void(0);" class="d-block"><img
                                                src="{{ asset('') }}client/img/pant.png" class="img-fluid"
                                                width="40" alt="" /></a>
                                    </div>
                                </div>
                                <div class="sl_cat_02">
                            ...
                            <div class="cats_side_wrap text-center">
                                <div class="sl_cat_01">
                                    <div
                                        class="d-inline-flex align-items-center justify-content-center p-3 circle mb-2 gray">
                                        <a href="javascript:void(0);" class="d-block"><img
                                                src="{{ asset('') }}client/img/fashion.png" class="img-fluid"
                                                width="40" alt="" /></a>
                                    </div>
                                </div>
                                <div class="sl_cat_02">
                            ...
                            <div class="cats_side_wrap text-center">
                                <div class="sl_cat_01">
                                    <div
                                        class="d-inline-flex align-items-center justify-content-center p-3 circle mb-2 gray">
                                        <a href="javascript:void(0);" class="d-block"><img
                                                src="{{ asset('') }}client/img/sneakers.png" class="img-fluid"
                                                width="40" alt="" /></a>
                                    </div>
                                </div>
                                <div class="sl_cat_02">
                            ...
                            <div class="cats_side_wrap text-center">
                                <div class="sl_cat_01">
                                    <div
                                        class="d-inline-flex align-items-center justify-content-center p-3 circle mb-2 gray">
                                        <a href="javascript:void(0);" class="d-block"><img
                                                src="{{ asset('') }}client/img/television.png" class="img-fluid"
                                                width="40" alt="" /></a>
                                    </div>
                                </div>
                                <div class="sl_cat_02">
                            ...
                            <div class="cats_side_wrap text-center">
                                <div class="sl_cat_01">
                                    <div
                                        class="d-inline-flex align-items-center justify-content-center p-3 circle mb-2 gray">
                                        <a href="javascript:void(0);" class="d-block"><img
                                                src="{{ asset('') }}client/img/accessories.png" class="img-fluid"
                                                width="40" alt="" /></a>
                                    </div>
                                </div>
                                <div class="sl_cat_02">
                ...
                <div class="right-ch-sideBar">
                    ...
                    <div class="cart_select_items py-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between br-bottom px-3 py-3">
                            <div class="cart_single d-flex align-items-center">
                                <div class="cart_selected_single_thumb">
                                    <a href="#"><img src="{{ asset('') }}client/img/product/4.jpg"
                        ...
                        <div class="d-flex align-items-center justify-content-between br-bottom px-3 py-3">
                            <div class="cart_single d-flex align-items-center">
                                <div class="cart_selected_single_thumb">
                                    <a href="#"><img src="{{ asset('') }}client/img/product/7.jpg"
                                            width="60" class="img-fluid" alt="" /></a>
                                </div>
                                <div class="cart_single_caption pl-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between px-3 py-3">
                            <div class="cart_single d-flex align-items-center">
                                <div class="cart_selected_single_thumb">
                                    <a href="#"><img src="{{ asset('') }}client/img/product/8.jpg"
                                            width="60" class="img-fluid" alt="" /></a>
                                </div>
                                <div class="cart_single_caption pl-2">
