...
<!-- Mirrored from themezhub.net/kumo-demo-2/kumo/shop-style-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 25 Nov 2022 17:39:43 GMT -->
<head>
    <meta charset="utf-8" />
...
<div id="main-wrapper">
            ...
            <nav id="navigation" class="navigation navigation-landscape">
                ...
                <div class="nav-menus-wrapper" style="transition-property: none;">
                    ...
                    <ul class="nav-menu nav-menu-social align-to-right">
                        ...
                        <li>
                            <a href="#" onclick="openWishlist()">
                                <i class="lni lni-heart"></i><span class="dn-counter theme-bg">2</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" onclick="openCart()">
                                <i class="lni lni-shopping-basket"></i><span class="dn-counter bg-info">3</span>
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <!-- ======================= Shop Style 1 ======================== -->
    <section class="bg-cover" style="background:url(../../client/img/bg.jpg) no-repeat;">
        <div class="container">
